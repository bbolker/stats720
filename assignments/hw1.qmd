...
Some places to look for interesting data: `?datasets` in base R; the `faraway` or `mlbench` package (although the latter has only a few continuous-response, regression-type data sets; more are about classification).
...
* intercept (average value of Control and Impact during the Before period)
* difference between Control and Impact before treatment
* difference between (average of Control and Impact) between Before and After
* difference between (C-I) difference between Before and After periods (this is the effect of primary interest)
