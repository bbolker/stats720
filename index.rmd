...
- 2:30-3:30 Tues, 2-4 Thurs, Hamilton Hall 410

### Misc info

- Textbooks:
   - none, but references will be listed
- [Full course bibliography](stat720_bib.html)
...
- [The back-end for this site](https://github.com/bbolker/stat720)
...
mk_url <- function(x) {
  ifelse(nchar(trimws(x))==0,x,
         sprintf("[%s](https://bbolker.github.io/stat720/%s.html)",
                 x,x))
}
